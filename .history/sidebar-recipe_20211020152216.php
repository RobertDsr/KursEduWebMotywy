<div class="right">
                    <section class="overview">
                        ...
                        <div class="time middle">Czas:<?php echo "  "; ?><?php echo printPreparationTime($post->ID); ?></div>
                        <div class="diet">Dieta:<?php echo "  "; ?><?php echo get_post_meta($post->ID, 'dieta', true); ?> kcal</div>
                    </section>
