...
function show_admin_panel_message() {
    ...
    if(empty($key)) {
        echo '<div id="message" class="error"><p><strong>Szablon ILoveToEat wymaga podania klucza Google Maps API</strong></p></div>';
    }
}
        ...
        <div class="wrap">
            ...
            <form action="options.php" method="post" id="ilte-options-form">
                ...
                <h3>
                    ...
                    <input name="ilte_gmap_api_key" id="ilte_gmap_api_key" type="text" style="width:500px;" value="<?php echo esc_attr(get_option('ilte_gmap_api_key')); ?>"
                </h3>
