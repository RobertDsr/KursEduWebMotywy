            ...
            <div class="pos-center">
                <div class="left">
                    ...
                    <?php if(have_posts()) :?>
                        ...
                        <section id="restaurants-<?php the_ID(); ?>" class="<?php post_class( 'entry' )?>">
                            <a href="<?php the_permalink($post)?>"><img src="content/restaurant-thumbnail1.jpg" alt="restaurant-thumbnail3" /></a>
